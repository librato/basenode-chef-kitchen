#
# Invoked on the first boot to move directories on to
# the ephemeral raid partition and set app names.
#
...
include_recipe "services::firstboot"
...
cron "run_zk_purge_txnlogs" do
  minute "0"
  hour "0"
  command "/usr/local/cron_scripts/zk_purge_txnlogs.sh"
end
